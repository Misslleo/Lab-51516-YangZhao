...
test_dataset = FlameSet('C:/Users/Yang Zhao/PycharmProjects/rob/outputt/test')

class SuperpixelSCDataset1(InMemoryDataset):
    ...
    def __init__(self, root,
        ...
        super(SuperpixelSCDataset1, self).__init__(root, pre_transform=self.pre_transform)
    ...
    def process(self):
        ...
        data_list = Parallel(n_jobs=self.n_jobs, prefer="threads") \
            (delayed(self.pre_transform)(image) for image in tqdm(test_dataset))
